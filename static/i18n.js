...
(function () {
  const T = {
    es: {
      ...
      update_available: "Nueva versión disponible ({v})",
      update_now: "Actualizar",
      update_dismiss: "Descartar",
      update_view: "Ver novedades",
      update_downloading: "Descargando actualización… {pct}%",
      update_installing: "Instalando y reiniciando…",
      update_error: "No se pudo actualizar. Inténtalo más tarde.",
